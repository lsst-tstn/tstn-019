...
deployment via Docker containers. We currently leverage a `docker-compose`
mechanism for container deployment to host services. With the proliferation of
Kubernetes (k8s) clusters around the Vera C. Rubin Observatory and the
associated sites, a new style of deployment and configuration is needed. We
will leverage the experience SQuaRE has gained deploying the EFD and Nublado
